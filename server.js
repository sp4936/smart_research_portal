...
app.post('/api/search', async (req, res) => {
  ...
  switch (dataType) {
    case 'COMBINED_DATA':
      query = `SELECT SOURCE,	CUSTOMER_NAME, ADDRESS,	CITY,	STATE,	WEBSITE,	ZIP_CODE,	RSSD_ID, CERTIFICATE_NUMBER,INDUSTRY_TYPE,	TOTAL_ASSETS,		CIK_ID,	FDIC_ID,	FAX,	PHONE,	INACTIVE,	NET_INCOME,		ABA_NUMBER,	LAST_UPDATED_DATE FROM dev_fccdw.CS_CUSTOMER_RESEARCH_DATA`;
      break;
    case 'SNP_GLOBAL_DATA':
